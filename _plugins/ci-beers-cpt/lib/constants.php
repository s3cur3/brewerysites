...
if( !defined('CI_BEER_TYPE') ) define("CI_BEER_TYPE", "ci-beer");
if( !defined('CI_BEER_IMG') ) define("CI_BEER_IMG", CI_BEER_TYPE . '-photo');
if( !defined('CI_BEER_IMG_SM') ) define("CI_BEER_IMG_SM", CI_BEER_TYPE . '-thumbnail');
